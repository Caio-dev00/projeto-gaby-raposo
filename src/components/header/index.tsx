        ...
        <header className="flex w-full max-7xl items-center justify-between">
          ...
          {toggleButton && (
            <div className="none max-w-[90%] w-full md:hidden absolute pt-[18rem] z-10">
              <ul ref={divRef} className="w-3/4 font-medium flex flex-col p-4 mt-4 rounded-lg bg-wine-light ">
                <li>
                  <a href="#" className="block py-2 px-3 text-gray-100 rounded">Pagina Incial</a>
                </li>
                <li>
                  <a href="#" className="block py-2 px-3 text-gray-100 rounded">Catálogo</a>
                </li>
                <li>
                  <a href="#" className="block py-2 px-3 text-gray-100 rounded">Sobre</a>
                </li>
                <li>
                  <a href="#" className="block py-2 px-3 text-gray-100 rounded">Contato</a>
                </li>
              </ul>
            </div>
          )}
