...
export function HeaderDashboard() {
  ...
  return (
    <aside className="w-[300px] bg-wine-black fixed h-full overflow-auto">
      <div className= "w-full bg-center bg-repeat bg-cover h-[150px] p-[30px]">
        <img 
       ...
       <div className="flex flex-col justify-start pt-8 pl-2">
